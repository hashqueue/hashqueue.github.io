...
### 选项用法示例
* `-i`：忽略大小写
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-fcc343964a1643a08a2aecf33c4467f6.png)
* `-c`：只输出匹配行的数量
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-d63d22bfaa474b288297af088245b3b1.png)
* `-n`：显示行号
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-14ed2de3668e4891a9a2ff91b0a94677.png)
* `-r`：递归搜索
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-ecc5d1497d6143708f878b532e62f82d.png)
* `-E`：支持拓展正则表达式(默认`grep`后边只能使用基础的`正则表达式`，如果需要使用高级的`正则表达式`，则需要加上`-E`选项)
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-4615baac8ecb460c92ef21fa1b4ae7d7.png)
* `-w`：匹配整个单词
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-5c980846556842d28aada31263c3e6ac.png)
* `-L`：只列出匹配的文件名
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-0a67d664f33f47d192cce4719951f5a0.png)
* `-F`：不支持正则，按字符串字面意思进行匹配
    ![image.png](https://www.wenbin.org.cn/upload/2020/07/image-42f6fc4685bd4200a9d44b9bdee95b9d.png)
